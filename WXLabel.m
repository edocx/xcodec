        ...
        for (int j = 0; j < CFArrayGetCount(runs); j++) {
            ...
            if (imageName) {
                ...
                if (image) {
                    ...
                    //#warning 设置图片的大小
                    imageDrawRect.size = CGSizeMake(self.font.pointSize * 1.5, self.font.pointSize * 1.5);
                    imageDrawRect.origin.x = runRect.origin.x + lineOrigin.x;
                    imageDrawRect.origin.y = lineOrigin.y - self.font.pointSize * .35;
...
//                    if (i == CFArrayGetCount(runs)-1) {
                        rowWid = imageDrawRect.origin.x+self.font.pointSize * 1.5;
//                    }
                }
    ...
    self.rowWidth = rowWid+_lastLineWidth;
    //－－－－－－－－－－－－－－－获取当前文本的高度－－－－－－－－－－－－－－－－－－
    //获取当前的行高
...
{
    //获取当前的行高
    float lineHeight = self.font.pointSize*1.2 + self.linespace;
